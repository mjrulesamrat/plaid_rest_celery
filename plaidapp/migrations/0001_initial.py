# Generated by Django 2.2.11 on 2020-03-22 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='balances', to='plaidapp.Account')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='account',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='plaidapp.PlaidItem'),
        ),
        migrations.AddField(
            model_name='account',
            name='user',
